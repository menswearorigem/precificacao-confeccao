...
export default function CalendarioPage() {
  ...
  function carregar() {
    const params = new URLSearchParams({ data_inicio: isoDoDia(inicioGrade), data_fim: isoDoDia(fimGrade) });
  ...
  useEffect(carregar, [inicioGrade, fimGrade, categoria, responsavelId, status, busca]); // eslint-disable-line react-hooks/exhaustive-deps
